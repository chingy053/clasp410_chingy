...
for kk in range(len(n_4)):
    ...
    temp_4[kk] = Stefan_Boltzmann(n_layer_atmos(int(n_4[kk]), epsilon=1,albedo=0,s0=2600, debug = False))[0]
...
ax3.text(480, 31, "Solar Irradiance = 2600 W/m$^{2}$, Albedo = 0, Emissivity = 1", fontsize=16, color="k")
ax3.grid(True)
