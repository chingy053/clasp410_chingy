...
ax1.plot(time_E_C_Q1,N1_E_C_Q1,"b", linewidth=2, label="N1, Euler")
ax1.plot(time_E_C_Q1,N2_E_C_Q1,"r", linewidth=2, label="N2, Euler")
ax1.plot(time_R_C_Q1,N1_R_C_Q1,"b:", linewidth=2, label="N1, RK8")
ax1.plot(time_R_C_Q1,N2_R_C_Q1,"r:", linewidth=2, label="N2, RK8")
...
ax2.plot(time_E_PP_Q1,N1_E_PP_Q1,"b", linewidth=2, label="N1 (Prey), Euler")
ax2.plot(time_E_PP_Q1,N2_E_PP_Q1,"r", linewidth=2, label="N2 (Predator), Euler")
ax2.plot(time_R_PP_Q1,N1_R_PP_Q1,"b:", linewidth=2, label="N1 (Prey), RK8")
ax2.plot(time_R_PP_Q1,N2_R_PP_Q1,"r:", linewidth=2, label="N2 (Predator), RK8")
