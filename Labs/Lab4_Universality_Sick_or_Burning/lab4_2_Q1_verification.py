...
'''
This file solve Question 1 (prompt as shown below) using a 3x3 grid from Lab 4 to verify the functions.
...
plot_forest2d(isize=3,jsize=3,nstep=4,save_dir='./', txt_label = True, save_name='lab4_2_Q1_veri_3x3_fire_at_center')
plot_forest2d_animation(isize=3,jsize=3,nstep=4, txt_label = True, 
              save_dir='./', 
              save_name='lab4_2_Q1_veri_3x3_fire_at_center')